...
Page({
  ...
  onLoad: function (options) {
    ...
    console.log(options)
    var lmid=options.lmid;//大类id
    var id=options.id; //子类id
...
if(lmid){
  var url="https://www.qunqing168.com/ecmsapi/index.php?mod=eapidb&act=categorylist";
  var id=lmid;
  that.setData({
    url:url,
    isbiglei:true, //是否大类
  ...
  var url="https://www.qunqing168.com/ecmsapi/index.php?mod=eapidb&act=categoryzlist";
  var id=id;
  that.setData({
    url:url,
    isbiglei:false, //是否大类
  ...
  nextPage: function () {
    //var isbiglei=this.data.isbiglei;
    //var isdanlei=this.data.isdanlei;
    var id=this.data.id;
