...
/*     if (type == 1) {
  ...
  bindFormSubmit: function (e) {
    ...
    var id = self.data.id;
    wx.request({
      url: 'https://www.qunqing168.com/ecmsapi/index.php?mod=eapidb&act=spxxxg', //商品信息添加
      ...
      success: function (res) {
        ...
        //var id = res.data;
        frombiaodan.data=res.data.data
        self.setData({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://www.qunqing168.com/ecmsapi/index.php?mod=eapidb&act=frombiaodanxg',
      data: {
        classid: options.lmid,
        id:options.id,
      },
  ...
  bindRegionChange: function (e) {
    ...
    region['city'] = value[1];
    region['area'] = value[2];
    region['befrom'] = this.data.region['befrom'];
